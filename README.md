...
- Editar archivos.
- Añadir mensajes de commit para describir los cambios de las nuevas versiones.
- Analizar el historial de versiones.

### AUTOR
Pedro Victoria Soriano
- Estudiante de PAI 5.
- Principiante en el lenguaje Python.
